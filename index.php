        ...
        <div class = "col-md-6 col-md-offset-3">
            <div class = "panel panel-primary">
                ...
                if ($error == "AccountCreated") {
                  echo '<p class="primary">Account Successfully Created</p>';
              }
              ?>
                <div class = "panel-body">
                    <form id = "registration" method="post" action="post.php" onsubmit="return submitUserForm();" enctype="multipart/form-data">
                        ...
                        <br/>
                        <input type="text" class="form-control" placeholder="Date of birth  mm/dd/yyyy" data-provide="datepicker" name="DOB">
                        <br/>
                        <div class = "gender">
                            <label class="radio-inline"><input type="radio" name="gender" value="male" class = "form-contorl"/>Male</label>
                        ...
                        <div class = "skills" id="checkboxes">
                            <label class="checkbox-inline"><input type="checkbox"  name = "skills[]" value="Coding" onclick="return mySkill()">Coding</label>
                        ...
                        <br/>
                        <input class="form-control" type="number" placeholder="Enter zipcode" name="zipcode">
                        <br/>
